...
import { IProject, AtlasRegion } from './index';
...
export class PrivateEndpoint extends Resource implements IPrivateEndpoint {
  ...
  constructor(scope: Construct, id: string, props: PrivateEndpointProps) {
    ...
    const region = props.region ?? AtlasRegion.US_EAST_1;
    const resource = new CfnPrivateEndpoint(this, 'Resource', {
   ...
   */
  private atlasRegion2Aws(region: AtlasRegion): string {
